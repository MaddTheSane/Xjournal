...
+ (void)initialize;
{
    ...
    centerBackgroundImage = [NSImage imageNamed:@"XJDockStatusItemCenter"];
    rightBackgroundImage = [NSImage imageNamed:@"XJDockStatusItemRight"];
...
- (void)drawDockStatusItemOnApplicationIcon:(NSImage *)applicationIcon;
{
    ...
    if (!leftBackgroundImage || !centerBackgroundImage || !rightBackgroundImage) {
        NSLog(@"XJDockStatusItem: Required background image is nil!");
        return;
    }
