...
#import "XJYear+OOutlineExtensions.h"


@implementation XJYear (OOutlineExtensions)
- (NSString *)outlinerRepresentation
{
    ...
    [string appendString: [NSString stringWithFormat: @"%d", [self yearName]]];
    ...
    //[string appendString: [[months objectAtIndex: 0] outlinerRepresentation]];
